...
HD_PWD='C:/Users/ASUS/riscv/riscv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_instruction_reader.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_instruction_reader.tcl -notrace
