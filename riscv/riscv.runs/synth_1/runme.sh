...
HD_PWD='C:/Users/ASUS/riscv/riscv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_instruction_reader.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_instruction_reader.tcl
