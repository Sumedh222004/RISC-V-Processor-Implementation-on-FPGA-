...
HD_PWD='C:/Users/ASUS/test_mul/test_mul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_matrix_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_matrix_bram.tcl
