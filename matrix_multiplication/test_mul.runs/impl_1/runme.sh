...
HD_PWD='C:/Users/ASUS/test_mul/test_mul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_matrix_bram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_matrix_bram.tcl -notrace
